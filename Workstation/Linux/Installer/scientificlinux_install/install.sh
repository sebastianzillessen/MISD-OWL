...
# Workstation.
# This file is recommended for the distribution ScientificLinux 6.1.
#-------------------------------------------------------------------------------------
ROOT_UID="0"
...
echo "Installing MISD WorkstationService on Scientific Linux OS..."
...
#set links for boot and shutdown (scientificLinux)
chkconfig --add misd
