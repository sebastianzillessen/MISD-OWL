...
{
    /// <summary>
    /// Provides a threadsafe implementation of ExtendedObservableCollection.
    /// </summary>
    [Serializable]
    public class ExtendedObservableCollection<T> : ObservableCollection<T>
    {
        ...
        //    else
        //        dispatcher.BeginInvoke((Action)(() => { DoMove(oldIndex, newIndex); }));
        //}
        ...
        //    if (CollectionChanged != null)
        //        CollectionChanged(this, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Move, temp, newIndex, oldIndex));
        //    sync.ReleaseWriterLock();
        //}
