...
namespace MISD.Plugins.Visualization.Events
{
    ...
    public class Events : IPluginVisualization
    {
        public string Name
        {
            get { return "Events"; }
        ...
        public string CalculateMainValue(IEnumerable<Indicator> indicators)
        {
            ...
            try
            {
                return indicators.First().IndicatorValues.Count().ToString();
